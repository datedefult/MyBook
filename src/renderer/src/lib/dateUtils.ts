...
export function formatDate(dateStr: string, language: ResolvedLanguage = 'zh'): string {
  ...
  return language === 'zh'
    ...
    : format(date, 'yyyy MMM d', { locale: enUS })
}

export function formatWeekday(dateStr: string, language: ResolvedLanguage = 'zh'): string {
  const date = parseISO(dateStr)
  return language === 'zh'
...
export function formatDateLocal(date: Date, language: ResolvedLanguage = 'zh'): string {
